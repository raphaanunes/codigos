...
focoBt.addEventListener('click', () => {
    ...
    texto.setAttribute('h1', 'Otimize sua produtividade,<br>
...
longoBt.addEventListener('click', () => {
    ...
    banner.setAttribute('src', '/Cursos JavaScript/JavaScript - Manipulando o elemento DOM/Fokus-projeto-base/imagens/descanso-longo.png')
})
