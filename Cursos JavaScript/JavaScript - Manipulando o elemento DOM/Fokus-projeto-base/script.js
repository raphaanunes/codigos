...
let tempoDecorridoEmSegundos = 2700
...
function zerar() {
    ...
    pausaImg.setAttribute('src', '/Cursos JavaScript/JavaScript - Manipulando o elemento DOM/Fokus-projeto-base/imagens/play_arrow.png')
    intervaloId = null
}
